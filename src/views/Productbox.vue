<template>
    ...
    <div  @mouseenter="hovered = true" @mouseleave="hovered = false" class="box">
        <router-link
            ...
            exact
        >
            <div class="pic" :style="{'background-image': product.hoveredImage && hovered ? 'url(' + product.hoveredImage +')' : 'url(' + product.image +')' }">
                    <div v-if="hovered" class="element-holder">
                        ...
                        <div class="element"><i class="material-icons">shuffle</i></div>
                        <div class="element"><i class="material-icons">search</i></div>
                    </div>
