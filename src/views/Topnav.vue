    ...
    <div style="width:100%" class="row align-items-center justify-content-between">
        <div class="col-md-3">
            <router-link
                ...
                tag="div"
            >
                <div class="brand-name ml-4 text-center text-md-left">
                    LEZADA
                </div>
            </router-link>
        </div>
        ...
        <div class="col-md-2">
            <div class="icons">
                ...
                <i @click="openSaved()" class="material-icons">favorite_border <div v-if="savedItems.length>0" class="red">{{savedItems.length}}</div></i>
                <i @click="openCart()" class="material-icons">local_grocery_store <div  v-if="cartItems.length>0" class="red">{{cartItems.length}}</div></i>
            </div>
        </div>
    </div>
